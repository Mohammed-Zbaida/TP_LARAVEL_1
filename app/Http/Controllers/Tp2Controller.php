...
class Tp2Controller extends Controller
{
    ...
    public function store(ValidFormRequest $request)
    {
        ...
        return redirect()->route('tp2.index')->with('success', 'Product has been created successfully');
    }
    ...
    public function update(ValidFormRequest $request, $id)
    {
        ...
        return redirect()->route('tp2.index')->with('success', 'Product has been updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('tp2.index')->with('success', 'Product has been deleted successfully');
    }
}
